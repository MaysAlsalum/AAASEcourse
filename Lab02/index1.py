...
"""test_search = search_tool.invoke(
    {"query": "Enterprise Agentic AI Systems"}
)
...
def collect_node(state: AgentState):
    ...
    query = refinements[
        min(iteration - 1, len(refinements) - 1)
    ]
...
def analyze_node(state: AgentState):
    """LLM-analyze each source with memory retrieval."""
...
def evaluate_node(state: AgentState):
    ...
    result = evaluator.invoke([
        HumanMessage(
            content=f"""
Evaluate the overall quality of this research from 1 to 10.
...
if __name__ == "__main__":
    ...
    output_file = "enterprise_research_output.txt"

    with open(output_file, "w", encoding="utf-8") as file:

        file.write("================================================\n")
        file.write("FINAL ENTERPRISE RESEARCH REPORT\n")
        file.write("================================================\n\n")
